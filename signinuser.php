...
<div class="header">
<center><img src="dist/img/head.png" width="1474" height="158" class="logo"></center>
...
<div class="login-box">
  ...
  <div class="card ">
    <div class="card-body login-card-body">
      ...
      <p class="mb-1">
       <center> <a href="forgotpassword.php">I forgot my password</a> </center>
      </p>
...
if (ISSET($_POST['btnSubmit'])){
    ...
    if ($data != null && $data['count'] != 0){
        ...
        echo (popUp("success","Authenticated", "Welcome! ". $fullname ,"indexuser.php"));
        exit();
    }
    else{
